declare const _default: {
    ...
    'uniq': <T>(arr: T[]) => T[];
    'where': <T extends object>(this: import("../../template/filter/filter-impl").FilterImpl, arr: T[], property: string, expected?: any) => T[];
    ...
    'sort_natural': (input: any[], property?: string | undefined) => any[];
